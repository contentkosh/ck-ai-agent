...
class LLMResponseException(KBBaseException):
    ...
    """
    def __init__(self,message: str = "LLM response generation failed.",
    ):
        super().__init__(message=message,error_code=ErrorCodes.LLM_RESPONSE_FAILED,)
...
class LLMTimeoutException(KBBaseException):
    ...
    def __init__(self,message: str = "LLM request timed out.",
        ...
        super().__init__(message=message,error_code=ErrorCodes.LLM_TIMEOUT,)