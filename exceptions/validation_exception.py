...
class InvalidFileException(KBBaseException):
    ...
    def __init__(self,message: str = "Invalid file uploaded.",
        ...
        super().__init__(message=message, error_code=ErrorCodes.INVALID_FILE_TYPE,)
...
class InvalidTagException(KBBaseException):
    ...
    def __init__(self,message: str = "Invalid tag.",
        ...
        super().__init__(message=message,error_code=ErrorCodes.INVALID_TAG,)
...
class EmptyFileException(KBBaseException):
    ...
    def __init__(
        ...
        super().__init__(message=message,error_code=ErrorCodes.EMPTY_FILE,)
